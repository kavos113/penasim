...
object Generator {
    ...
    private fun reduceExplicitVisibility(code: String): String =
        code.replace("""import kotlin.(String|Int|Long|UInt|ULong|Double|Float|Boolean)\n""".toRegex(), "")
            .replace("""import kotlin.(String|Int|Long|UInt|ULong|Double|Float|Boolean)""".toRegex(), "")
